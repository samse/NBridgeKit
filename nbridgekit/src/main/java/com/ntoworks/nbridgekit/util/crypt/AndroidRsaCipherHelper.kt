...
object AndroidRsaCipherHelper {
    ...
    internal fun init(applicationContext: Context) {
        if (isSupported) {
            print("Already initialised - Do not attempt to initialise this twice")
            return
        }
        ...
        result = if (keyStore.containsAlias(alias)) {
            ...
            print("No keypair for $alias, creating a new one")
    ...
    private fun initAndroidM(alias: String): Boolean {
        try {
            ...
            print("Random keypair with ${KeyProperties.KEY_ALGORITHM_RSA}/${KeyProperties.BLOCK_MODE_CBC}/${KeyProperties.ENCRYPTION_PADDING_RSA_PKCS1} is created.")
             ...
             */
            print("It seems that this device does not support RSA algorithm!!")
    ...
    private fun initAndroidL(alias: String): Boolean {
        try {
            ...
            print("Random RSA algorithm keypair is created.")

            return true
        } catch (e: GeneralSecurityException) {
            print("It seems that this device does not support encryption!! ${e.message}")
